            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-stretch">
                    ...
                    <div className="flex-1 px-4 mb-8 md:mb-0">
                        <div className="flex flex-col items-center">
                            <div className="relative">
                                <Truck size={80} className="mb-4 text-blue" />
                                <div className="absolute inset-y-0 right-0 w-1 bg-blue-500"></div>
                            </div>
                            <h1 className="font-bold text-xl text-blue font-primary">Envíos</h1>
                            <p className="text-center mt-4 font-secondary">
                    ...
                    <div className="flex-1 px-4 mb-8 md:mb-0">
                        <div className="flex flex-col items-center">
                            <div className="relative">
                                <CirclePercent size={80} className="mb-4 text-blue" />
                            </div>
                            <h1 className="font-bold text-xl text-blue font-primary">Nuestro Boletín</h1>
                            <p className="text-center mt-4 font-secondary">
                    ...
                    <div className="flex-1 px-4 mb-8 md:mb-0">
                        <div className="flex flex-col items-center">
                            <div className="relative">
                                <MapPinned size={80} className="mb-4 text-blue" />
                            </div>
                            <h1 className="font-bold text-xl text-blue font-primary">Ubicación</h1>
                            <p className="text-center mt-4 font-secondary">
